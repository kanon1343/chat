...
pub mod chat_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_message(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("chat.ChatService", "SendMessage"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("chat.ChatService", "StreamMessages"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/chat.ChatService/SendMessage" => {
                    ...
                    impl<T: ChatService> tonic::server::UnaryService<super::ChatMessage>
                ...
                "/chat.ChatService/StreamMessages" => {
                    #[allow(non_camel_case_types)]
                    struct StreamMessagesSvc<T: ChatService>(pub Arc<T>);
                    impl<
                        T: ChatService,
                    ...
                    for StreamMessagesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChatService>::stream_messages(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
